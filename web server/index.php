...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="row" style="color:rgb(255,255,255);">
            <div class="col-md-12">
                <div class="card" style="border: none;"><img class="card-img w-100 d-block" style="background-color:#3e3e3f;background-position:center center;background-size: 100% auto;background-image:url(&apos;'.$map_img.'&apos;);height:160px;-webkit-filter:blur(4px);filter:blur(4px);">
